    ...
    <script type="text/javascript">
	 var _menus = {"menus":[
						...
						{"menuid":"2","icon":"","menuname":"学生信息管理",
							"menus":[
									{"menuid":"21","menuname":"本科生学生列表","icon":"icon-user-student","url":"StudentServlet?method=toStudentListView"},
									{"menuid":"21","menuname":"研究生学生列表","icon":"icon-user-student","url":"PostgraduateServlet?method=toStudentListView"},
								]
						},
						<c:if test="${userType == 1 || userType == 3}">
						{"menuid":"4","icon":"","menuname":"班级信息管理",
							"menus":[
									{"menuid":"42","menuname":"本科生班级列表","icon":"icon-house","url":"ClazzServlet?method=toClazzListView"}
								]
						},
						</c:if>
						<c:if test="${userType == 1 || userType == 3}">
						...
						<c:if test="${userType == 1 || userType == 4}">
