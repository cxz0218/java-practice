				...
				.datagrid(
						{
							...
							fit : true,//自动大小 
							method : "post",
							url : "PostgraduateServlet?method=StudentList&t="
									+ new Date().getTime(),
							idField : 'id',
												...
												function(r) {
													if (r) {
														$
																.ajax({
																	type : "post",
																	url : "PostgraduateServlet?method=DeleteStudent",
																	data : {
																		sns : numbers,
																		ids : ids
																	},
										...
										handler : function() {
											...
											if (!validate) {
												...
												$
														.ajax({
															type : "post",
															url : "PostgraduateServlet?method=AddStudent",
															data : $("#addForm")
																	.serialize(),
															success : function(
																	msg) {
									...
									},
									{
										...
										handler : function() {
											...
											$("#add_major").textbox('setValue',
													"");
											$("#add_researchDir").textbox(
													'setValue', "");
											$("#add_tutor").textbox('setValue',
													"");
											//重新加载年级
				...
				.dialog(
						{
										...
										handler : function() {
											...
											if (!validate) {
												...
												$
														.ajax({
															type : "post",
															url : "PostgraduateServlet?method=EditStudent&t="
																	+ new Date()
																			.getTime(),
															data : $(
																	"#editForm")
							...
							onBeforeOpen : function() {
								...
								$("#edit_major").textbox('setValue',
										selectRow.major);
								$("#edit_researchDir").textbox('setValue',
										selectRow.researchDir);
								$("#edit_tutor").textbox('setValue',
										selectRow.tutor);
	...
	<div id="addDialog" style="padding: 10px">
		...
		<form id="addForm" method="post">
			<table cellpadding="8">
				...
				<tr>
					<td>年级:</td>
					<td><input id="add_grade" style="width: 200px; height: 30px;"
						class="easyui-textbox" type="text" name="grade" /></td>
				</tr>
				<tr>
					<td>专业:</td>
					<td><input id="add_major" style="width: 200px; height: 30px;"
						class="easyui-textbox" type="text" name="major" /></td>
				</tr>
				<tr>
					<td>研究方向:</td>
					<td><input id="add_researchDir"
						style="width: 200px; height: 30px;" class="easyui-textbox"
						name="researchDir" /></td>
				</tr>
				<tr>
					<td>导师:</td>
					<td><input id="add_headteacher"
						style="width: 200px; height: 30px;" class="easyui-textbox"
						type="text" name="tutor" /></td>
				</tr>
			</table>
		</form>
	</div>
	...
	<div id="editDialog" style="padding: 10px">
		...
		<form id="editForm" method="post">
			...
			<table cellpadding="8">
				...
				<tr>
					<td>出生日期:</td>
					<td><input id="edit_birthday"
						style="width: 200px; height: 30px;" class="easyui-textbox"
						type="text" name="birthday" /></td>
				</tr>
				<tr>
					<td>年级:</td>
				...
				<tr>
					<td>专业:</td>
					<td><input id="edit_major" style="width: 200px; height: 30px;"
						class="easyui-textbox" type="text" name="major" /></td>
				</tr>
				<tr>
					<td>研究方向：</td>
					<td><input id="edit_researchDir"
						style="width: 200px; height: 30px;" class="easyui-textbox"
						name="researchDir" /></td>
				</tr>
				<tr>
					<td>导师:</td>
					<td><input id="edit_tutor" style="width: 200px; height: 30px;"
						class="easyui-textbox" type="text" name="tutor" /></td>
				</tr>
			</table>
		</form>
	</div>
