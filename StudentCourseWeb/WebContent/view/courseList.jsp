	        ...
	        columns: [[  
				{field:'chk',checkbox: true,width:50},
 		        ...
 		        {field:'name',title:'课程名称',width:200},
 		       	...
 		       	{field:'credit',title:'学分',width:200},
	    	...
	    	buttons: [
	    		{
					...
					handler:function(){
						...
						if(!validate){
							...
							var credit = $("#edit_credit").textbox("getText");
							var maxNum = $("#edit_max_num").numberbox("getValue");
							var info = $("#edit_info").val();
							var data = {id:id, teacherid:teacherid, name:name,credit:credit,info:info,maxnum:maxNum};
